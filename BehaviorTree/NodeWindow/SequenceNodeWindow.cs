...
{
    public class SequenceNodeWindow : BehaviorNodeWindow
    {
        /// <summary>
        /// 前置条件执行函数
        /// </summary>
        ...
        public SequenceNodeWindow(int id) : base(BehaviorNodeType.Sequence, id, "顺序节点")
        {
            //设置输入输出区域
            ...
            WindowWidth = 180;
            WindowHeight = 62;
            WindowBackgroundColor = new Color(0.407843f, 0.803921f, 1f);
        }
